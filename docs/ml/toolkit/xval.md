...
date: October 2018
keywords: cross validation, machine learning, ml, utilities, K-folds, statistics, kdb+, q
---

Cross Validation is a technique used in machine learning to validate the stability of the model used. It is generally used in predictive cases and demonstrates how accurately a model will preform in practice on an independent dataset.
...
Load the cross validation library using:
...
Function                                               | Output
:------------------------------------------------------|-----------------------------
[`.ml.xval.chainxval`](xval.md#mlxvalchainxval)        |Score from a chain-forward cross validation 
[`.ml.xval.gridsearch`](xval.md#mlxvalgridsearch)      |Optimal parameters for machine-learning model through cross validation 
[`.ml.xval.gridsearchfit`](xval.md#mlxvalgridsearchfit)|K-Fold validated grid-search with optimal model fit to testing set 
[`.ml.xval.kfoldx`](xval.md#mlxvalkfoldx)              |K-Fold cross validation 
[`.ml.xval.kfshuff`](xval.md#mlxvalkfshuff)            |Randomized non-repeating indices for K-fold cross validation 
[`.ml.xval.kfsplit`](xval.md#mlxvalkfsplit)            |Ascending indices in K-folds 
[`.ml.xval.kfstrat`](xval.md#mlxvalkfstrat)            |Distribute data into K-folds with approx equal distribution of classes 
[`.ml.xval.mcxval`](xval.md#mlxvalmcxval)              |Score for monte-carlo cross validated model 
[`.ml.xval.repkfstrat`](xval.md#mlxvalrepkfstrat)      |Average score for repeated stratified randomized K-fold cross validation 
[`.ml.xval.repkfval`](xval.md#mlxvalrepkfval)          |Average score for repeated randomized K-fold cross validation 
[`.ml.xval.rollxval`](xval.md#mlxvalrollxval)          |Score from a roll-forward cross validation 
